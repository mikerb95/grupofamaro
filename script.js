...
const animatedElements = document.querySelectorAll('.sector-card, .value-item, .stat-item');
...
const updateYear = () => {
    ...
    if (yearElement) {
        ...
        yearElement.textContent = `© ${currentYear} Grupo FAMARO. Todos los derechos reservados.`;
    }
};
...
console.log(
    '%cGRUPO FAMARO',
    'font-size: 24px; font-weight: bold; color: #0f3460; padding: 10px;'
);
console.log(
    '%cTransformando Industrias, Construyendo Futuro',
    'font-size: 14px; color: #6c757d; padding: 5px;'
);
